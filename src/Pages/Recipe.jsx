        ...
        <div className="flex flex-col  w-1/2 ">
          <div className="flex mb-3">
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className="bg-black text-[10px] font-bold text-white p-2 mr-3"
            >
              Instructions
            </motion.button>
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className="border-2 text-[10px] font-bold border-black p-2 active:border-none active:text-white active:bg-black "
            >
              Ingredients
            </motion.button>
          </div>
          <p className="text-base font-medium">{recipe.instructions}</p>
        </div>
      </div>
    </div>
  );
